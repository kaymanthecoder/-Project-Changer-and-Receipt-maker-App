...
public class Poised {
	...
	public static void main(String[] args) {
		...
		members Steven = new members("Steven Smith", "+1 343-553-3323", "itsmeSteven123@gmail.com", "4498 Conway Vickers RD \n\t      Amrose \n\t      GA 31512 \n\t      United States");
		members Bob = new members("Bob Johnson", "+1 464-266-9555", "johnnyBravo07@gmail.com", "270 Silver brook Trail \n\t      Amrose \n\t      GA 31512 \n\t      United States");
		members Burns  = new members("Peter Burns", "+1 555-444-1389", "peter1993@gmail.com", "329 Saint Peterson Ave \n\t      Douglas \n\t      GA 31533 \n\t      United States");
		...
		do{
			...
			System.out.println("The total amount of the fee paid to date [2] (This will subtract the outstanding amount that still needs to be paid)");
			System.out.println("Contractor's contact details [3]");
		    userChoice = getcode.nextInt();
...
//===================FILE OUTPUT===========================
		...
		//This will print of the updated version of the invoice
				try {
